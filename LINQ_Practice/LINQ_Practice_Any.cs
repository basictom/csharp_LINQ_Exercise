...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_Any
    {
        ...
        {
            var doAny = PracticeData[2].Students.Any(s => s.Birthday.Month == 10);
        ...
        {
            var doAny = PracticeData[3].JuniorInstructors.Any(j => !j.Active);/*FILL IN LINQ EXPRESSION*/;  //HINT: Cohort4 is PracticeData[3]
            Assert.IsFalse(doAny); //<-- change true to doAny
        }
    }
}
